...
python2.7 $PATH_TO/ecg_interface/ecg_robot_code/src/main/robots/ros_solver.py ProblemSolver &
#python2.7 $PATH_TO/$SOLVER &
#python2.7 ecg_interface/robot_code/src/main/robots/ros_solver.py ProblemSolver &

export JYTHONPATH=$JYTHONPATH:$PATH_TO/ecg_interface/ecg_framework_code/build/compling.core.jar:$PATH_TO/ecg_interface/framework_code/src/main/nluas/language
